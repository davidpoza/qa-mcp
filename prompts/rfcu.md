...
- **COBERTURA DEL FRONTEND, NO SÓLO COHERENCIA INTERNA**: usa el inventario de controles UI añadido al final del prompt como checklist. Para todo CU que ejecute Calcular/Consultar/Buscar/Guardar/Enviar/Aceptar/Continuar, localiza el componente correspondiente al RF y cubre TODOS sus campos editables o seleccionables. No es válido omitir fecha/hora u otro control tanto de la acción humana como del contrato técnico.
